...
class _CustomDropdownMenuItemButton<T> extends StatefulWidget {
  ...
  @override
  _CustomDropdownMenuItemButtonState<T> createState() => _CustomDropdownMenuItemButtonState<T>();
}

class _CustomDropdownMenuItemButtonState<T> extends State<_CustomDropdownMenuItemButton<T>> {
  ...
  void _handleOnTap() {
    final CustomDropdownMenuItem = widget.route.items[widget.itemIndex].item!;

    CustomDropdownMenuItem.onTap?.call();

    Navigator.pop(
      context,
      _DropdownRouteResult<T>(CustomDropdownMenuItem.value),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.hint != null || (!_enabled && widget.disabledHint != null)) {
      ...
      if (widget.selectedItemBuilder == null)
        displayedHint = _CustomDropdownMenuItemContainer(child: displayedHint);
